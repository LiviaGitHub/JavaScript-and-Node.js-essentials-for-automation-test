 ...
 * 6. parseInt(), parseFloat(), .toString() method can be used to convert datatyoe.
 * 7. Be familiar with these notations: {}, [], /abc/, ""
 * 8. All primitive data types are imutable.
 * 9. Why do you need to stick with let or const?
 *     - Beacuse let and const support block scoping.
